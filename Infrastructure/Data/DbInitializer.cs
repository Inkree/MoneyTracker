    ...
    public class DbInitializer
    {
        ...
        public void Seed()
        {
            _modelBuilder.Entity<Transaction>(entity =>
            {
                ...
                entity.Property(e => e.Note).HasColumnType("varchar").HasMaxLength(50);
            ...
            _modelBuilder.Entity<Category>(entity =>
            {
                ...
                entity.HasMany(e => e.Transactions).WithOne(e => e.Category).HasForeignKey(e => e.CategoryId).OnDelete(DeleteBehavior.NoAction);
